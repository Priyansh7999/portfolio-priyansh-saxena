export const PERSONAL_INFO = {
    ...
    resume: 'https://drive.google.com/file/d/1Ej4N_632VMbSPfTF2mWv6OZyXTKgzZfb/view?usp=sharing',
    bio:[
...
export const SOCIAL_LINKS = {
    ...
    leetcode:'https://leetcode.com/u/priyansh7999/',
    instagram:'https://www.instagram.com/priyansh.saxena.5070/',
}
export const STATS = [
...
export const ABOUT_STATS = [
    {label: "Code Commits", value: "1.6k+"},
    {label: "GitHub Stars", value: "15"},
    {label: "Leetcode Rating", value: "1,585"},
]
